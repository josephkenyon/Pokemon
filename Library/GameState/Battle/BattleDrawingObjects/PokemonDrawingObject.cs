...
namespace Library.GameState.Battle.BattleDrawingObjects
{
    public class PokemonDrawingObject : BattleDrawingObject
    {
        ...
        public override Color GetColor() => Pokemon.UsedMove || Pokemon.IsFainted ? new Color(155, 155, 155, 255) : Color.White * (
            (((BattleStateManager.Battle.State == BattleState.FightSelect || BattleStateManager.Battle.State == BattleState.MoveSelect) && Direction == Direction.Left)
        ...
        public override bool WhiteFlash() => (((BattleStateManager.Battle.State == BattleState.FightSelect || BattleStateManager.Battle.State == BattleState.MoveSelect)
